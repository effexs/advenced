...
public class CustomerClassLoader extends PathClassLoader {
    ...
    public Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        for (int i = 0; i < length; i++) {
            if (this.mDexs[i] != null) {
                ...
                byte[] data2 = loadFromDirectory(this.mPaths[i] + "/" + name.replace('.', '/') + ".class");
            }
        }
    ...
    public String findLibrary(String libname) {
        ...
        for (int i = 0; i < this.mLibPaths.length; i++) {
            String pathName = this.mLibPaths[i] + fileName;
    ...
    public Package getPackage(String name) {
        ...
        synchronized (this) {
            ...
            if (pack == null) {
                pack = definePackage(name, "Unknown", "0.0", "Unknown", "Unknown", "0.0", "Unknown", (URL) null);
            }
        }
        return pack;
    }
